"""
Django settings for test_zinnia project.
...
SECRET_KEY = 'b&t_#7*30-mp^=sqe+2!l9#x_g4(z15!h$=j%7s_&=g*q6o&xe'
...
WSGI_APPLICATION = 'test_zinnia.wsgi.application'
